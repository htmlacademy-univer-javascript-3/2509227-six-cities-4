...
const MapComponent: React.FC<MapComponentProps> = ({ offers, cityCoords }) => {
  ...
  const highlightedOffer = useSelector((state: RootState) => state.rental.highlightedOffer);
  ...
  return <div id="map" style={{ height: '579px', width: '100%', marginBottom: '50px', backgroundPosition: 'center top', backgroundRepeat: 'no-repeat' }}></div>;
};
